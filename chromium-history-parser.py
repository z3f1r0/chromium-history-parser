...
def extract_history(db_path, output_csv):
    ...
    try:
        ...
        print(f"[!] Errore apertura SQLite (live): {e}")
        return
...
def main():
    parser = argparse.ArgumentParser(
        description="Estrazione forensic-ready della cronologia browser Chromium (Chrome, Edge, Brave, Opera, ecc.)"
    )

    parser.add_argument(
        "history_file", help="Percorso al file History del browser Chromium"
    )
